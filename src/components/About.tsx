...
const About: React.FC = () => {
  const highlights = [
    ...
    },
    {
      icon: Cloud,
      title: 'Cloud & DevOps',
      description: 'AWS, CI/CD, and scalable cloud infrastructure',
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed transition-colors duration-300">
              With 4+ years of experience in the software industry, I specialize in building 
              scalable web and mobile applications. My journey started at LTIMindTree and has 
              evolved through various challenging roles, each adding to my expertise in modern 
              development practices.
            </p>
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed transition-colors duration-300">
              Currently working at TSIM Communication Services, where I develop and maintain 
              the Instasim eSIM app using Flutter and Python, contributing to a 20% increase 
              in customer satisfaction through performance optimizations and feature enhancements.
            </p>
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed transition-colors duration-300">
              I'm passionate about clean code, user experience, and staying updated with the 
              latest technologies. I believe in continuous learning and applying best practices 
              to deliver exceptional software solutions.
            </p>

            <div className="flex flex-wrap gap-3 pt-4">
              {['React.js', 'Node.js', 'Python', 'Flutter', 'PostgreSQL', 'MongoDB', 'AWS'].map((tech) => (
                <span
                  key={tech}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {highlights.map((highlight, index) => (
              ...
              >
                ...
                <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2 transition-colors duration-300">{highlight.title}</h4>
                <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed transition-colors duration-300">{highlight.description}</p>
              </div>
            ))}
          </div>
        </div>
